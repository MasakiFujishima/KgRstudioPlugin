namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class AddCursorAboveCurrentCursor : PluginDynamicCommand
    {
        public AddCursorAboveCurrentCursor()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowUp, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
