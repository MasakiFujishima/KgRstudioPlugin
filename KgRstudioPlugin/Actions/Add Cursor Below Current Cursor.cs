namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class AddCursorBelowCurrentCursor : PluginDynamicCommand
    {
        public AddCursorBelowCurrentCursor()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowDown, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
