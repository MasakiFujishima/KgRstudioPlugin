namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class BuildMenu : PluginDynamicCommand
    {
        public BuildMenu()
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("Build Menu", color: new BitmapColor(245,247,229));
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyB, ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
