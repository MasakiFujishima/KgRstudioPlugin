namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class CloseActiveDocumentChromeOnly : PluginDynamicCommand
    {
        public CloseActiveDocumentChromeOnly()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyW, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
