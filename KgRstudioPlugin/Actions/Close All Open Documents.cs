namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class CloseAllOpenDocuments : PluginDynamicCommand
    {
        public CloseAllOpenDocuments()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyW, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
