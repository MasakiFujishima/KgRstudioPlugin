namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class CloseOtherDocuments : PluginDynamicCommand
    {
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyW, ModifierKey.Control | ModifierKey.Shift | ModifierKey.Alt);
        }
    }
}
