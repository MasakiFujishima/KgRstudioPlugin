namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class CodeMenu : PluginDynamicCommand
    {
        public CodeMenu()
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("Code Menu", color: new BitmapColor(245,247,229));
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyC, ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
