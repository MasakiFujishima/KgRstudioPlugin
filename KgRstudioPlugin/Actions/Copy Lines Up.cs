namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class CopyLinesUp : PluginDynamicCommand
    {
        public CopyLinesUp()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowUp, ModifierKey.Shift | ModifierKey.Alt);
        }
    }
}
