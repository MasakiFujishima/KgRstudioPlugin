namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ExpandSelection : PluginDynamicCommand
    {
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowUp, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
