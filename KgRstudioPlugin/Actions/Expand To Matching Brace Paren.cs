namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ExpandToMatchingBraceParen : PluginDynamicCommand
    {
        public ExpandToMatchingBraceParen()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyE, ModifierKey.Control | ModifierKey.Shift | ModifierKey.Alt);
        }
    }
}
