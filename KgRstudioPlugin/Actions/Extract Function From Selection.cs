namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ExtractFunctionFromSelection : PluginDynamicCommand
    {
        public ExtractFunctionFromSelection()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyX, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
