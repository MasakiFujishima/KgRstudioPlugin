namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class FileMenu : PluginDynamicCommand
    {
        public FileMenu()
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("File Menu", color: new BitmapColor(245,247,229));
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyF, ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
