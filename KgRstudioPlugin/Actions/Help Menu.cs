namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class HelpMenu : PluginDynamicCommand
    {
        public HelpMenu()
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("Help Menu", color: new BitmapColor(245,247,229));
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyH, ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
