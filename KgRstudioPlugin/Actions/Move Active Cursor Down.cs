namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class MoveActiveCursorDown : PluginDynamicCommand
    {
        public MoveActiveCursorDown()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowDown, ModifierKey.Control | ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
