namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class MoveActiveCursorUp : PluginDynamicCommand
    {
        public MoveActiveCursorUp()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowUp, ModifierKey.Control | ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
