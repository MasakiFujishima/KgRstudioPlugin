namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class MoveFocusToHelp : PluginDynamicCommand
    {
        public MoveFocusToHelp()
        : base(displayName: "Move Focus To Help", description: "Move Focus To Help", groupName: "Views")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("Move Focus To Help", color: new BitmapColor(238,205,225));
