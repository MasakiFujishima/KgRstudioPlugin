namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class PreviousHelpTopic : PluginDynamicCommand
    {
        public PreviousHelpTopic()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.F2, ModifierKey.Shift | ModifierKey.Alt);
        }
    }
}
