namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class RenameSymbolInScope : PluginDynamicCommand
    {
        public RenameSymbolInScope()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyM, ModifierKey.Control | ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
