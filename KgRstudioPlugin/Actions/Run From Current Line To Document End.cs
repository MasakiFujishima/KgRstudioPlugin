namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class RunFromCurrentLineToDocumentEnd : PluginDynamicCommand
    {
        public RunFromCurrentLineToDocumentEnd()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyE, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
