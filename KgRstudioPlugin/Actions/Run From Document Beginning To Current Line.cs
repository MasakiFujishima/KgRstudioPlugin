namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class RunFromDocumentBeginningToCurrentLine : PluginDynamicCommand
    {
        public RunFromDocumentBeginningToCurrentLine()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyB, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
