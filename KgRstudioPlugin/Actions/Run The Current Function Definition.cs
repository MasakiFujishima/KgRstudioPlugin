namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class RunTheCurrentFunctionDefinition : PluginDynamicCommand
    {
        public RunTheCurrentFunctionDefinition()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyF, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
