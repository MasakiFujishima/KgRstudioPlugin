namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class RunTheCurrentSweaveRmdChunk : PluginDynamicCommand
    {
        public RunTheCurrentSweaveRmdChunk()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyC, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
