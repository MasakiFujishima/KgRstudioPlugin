namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SelectToLineStart : PluginDynamicCommand
    {
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowLeft, ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
