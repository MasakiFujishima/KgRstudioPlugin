namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SelectWordRight : PluginDynamicCommand
    {
        public SelectWordRight()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.ArrowRight, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
