namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SendCurrentLineSelectionToTerminal : PluginDynamicCommand
    {
        public SendCurrentLineSelectionToTerminal()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.Return, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
