namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ShowCommandPalette : PluginDynamicCommand
    {
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyP, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
