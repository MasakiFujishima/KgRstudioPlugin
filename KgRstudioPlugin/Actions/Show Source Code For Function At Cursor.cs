namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ShowSourceCodeForFunctionAtCursor : PluginDynamicCommand
    {
        public ShowSourceCodeForFunctionAtCursor()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.F2);
        }
    }
}
