namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SourceAFile : PluginDynamicCommand
    {
        public SourceAFile()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyG, ModifierKey.Control | ModifierKey.Alt);
        }
    }
}
