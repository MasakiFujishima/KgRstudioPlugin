namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SourceTheCurrentDocumentWithEcho : PluginDynamicCommand
    {
        public SourceTheCurrentDocumentWithEcho()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.Return, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
