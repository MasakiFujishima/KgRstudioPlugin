namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SwitchToTab : PluginDynamicCommand
    {
        public SwitchToTab()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.Period, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
