namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class SyncEditorPdfPreview : PluginDynamicCommand
    {
        public SyncEditorPdfPreview()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.F8, ModifierKey.Control);
        }
    }
}
