namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ToggleVisualEditor : PluginDynamicCommand
    {
        public ToggleVisualEditor()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.F4, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
