namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ToolsMenu : PluginDynamicCommand
    {
        public ToolsMenu()
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("Tools Menu", color: new BitmapColor(245,247,229));
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyT, ModifierKey.Alt | ModifierKey.Shift);
        }
    }
}
