namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class UnfoldSelected : PluginDynamicCommand
    {
        public UnfoldSelected()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.KeyL, ModifierKey.Shift | ModifierKey.Alt);
        }
    }
}
