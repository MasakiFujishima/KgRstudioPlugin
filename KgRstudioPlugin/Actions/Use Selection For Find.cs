namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class UseSelectionForFind : PluginDynamicCommand
    {
        public UseSelectionForFind()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.F3, ModifierKey.Control);
        }
    }
}
