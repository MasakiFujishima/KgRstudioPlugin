namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ZoomHelp : PluginDynamicCommand
    {
        public ZoomHelp()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.NumPad3, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
