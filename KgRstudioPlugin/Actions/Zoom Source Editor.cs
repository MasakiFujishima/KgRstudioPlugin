namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ZoomSourceEditor : PluginDynamicCommand
    {
        public ZoomSourceEditor()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.NumPad1, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
