namespace Loupedeck.KgRstudioPlugin
{
    ...
    public class ZoomViewer : PluginDynamicCommand
    {
        public ZoomViewer()
        ...
        {
            this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.NumPad9, ModifierKey.Control | ModifierKey.Shift);
        }
    }
}
